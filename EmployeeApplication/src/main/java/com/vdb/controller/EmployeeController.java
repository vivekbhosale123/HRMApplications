...
//    private EmployeeService employeeService;
    ...
    public ResponseEntity<Page<Employee>> findAllEmployee(@RequestParam(defaultValue = "0")int page,
                                                          @RequestParam(defaultValue = "5") int size,
                                                          @RequestParam(defaultValue = "empName") String empName)
    {
        return new ResponseEntity<>(employeeService.findAllEmployee(page, size,empName), HttpStatus.OK);
    }
